...
$nullBody = Get-PayloadBody -Message ([string]$nullChunk[0].message)
Assert-True ($nullBody -ceq '<null>') 'A null response must be represented explicitly.'
